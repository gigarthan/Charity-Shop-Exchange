...
export default function Footer(props) {
  ...
  return (
    <div className="modal-footer" id="footer">
      ...
      <Subscription text="delivered every" formData={formData} button={button} showToolTip={showToolTip} showToolTip2={showToolTip2} quantity={quantity} orderSummary={orderSummary} handleSubmit={handleSubmit} handleChange={handleChange} newClass={newClass} billsbyData={billsbyData} totalDecimalSum={totalDecimalSum} />
      <a
        style={{ display: "none" }}
