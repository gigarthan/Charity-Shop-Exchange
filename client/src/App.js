  ...
  return (
    <div className="App">
      <div className="w-screen">
        <div className="py-4 px-20 bg-white border-b-2 shadow-lg">
        ...
        {/* Hero section */}
        {/* hero left */}
        <div className="flex items-stretch max-w-screen-md mt-12 mx-auto items-end">
        ...
        <div className="bg-new-navy pb-12 pt-12">
            <div className="flex flex-col items-end max-w-screen-md mx-auto">
                ...
                <div>
                  <button
                    className="border-2 border-gray-400 text-gray-400 px-16 rounded-full bg-transparent hover:bg-red-700 text-white font-semibold py-2 rounded focus:outline-none focus:shadow-outline"
                    type="button"
                  >
                    Sign In
                  </button>
        ...
        <div className="pt-12">
          <div className="mx-auto text-6xl font-bold text-red-700 text-center ">
            How it works
          </div>
          ...
          {/* mission section */}
          <div className="py-20 bg-new-gray">
