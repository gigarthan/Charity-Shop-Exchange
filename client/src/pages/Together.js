    ...
    <Layout>
      <div className="bg-new-navy">
          <div>
            ...
            <img className="w-8 sm:w-12 inline-block pb-4 mr-2" src={bicycle} alt="">
                </img> Connect the dots <img className="w-8 sm:w-12 inline-block pb-8 ml-2" src={uk} alt="">
                </img>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center bg-gray-100">
          <div className="-mt-10 sm:-mt-20 mx-auto w-11/12 max-w-4xl bg-white mb-40 rounded-lg shadow-2xl">
            ...
            <div className="mt-20 pt-12 pb-32 px-4 sm:px-20 bg-new-gray">
              ...
              <p className="text-xs sm:text-lg font-medium sm:font-semibold mt-4 text-gray-600 leading-normal">
              Are you a car dealership, supermarket, pub, garden centre or community organisation that can help?
We're ready to take the orders, the books & DVDs are already set aside in peoples home, we just need you to appeal for donations on behalf of your favourite charity and to become a book & DVD drop-off point.
              </p>
              <p className="text-xs sm:text-lg  font-medium sm:font-semibold mt-12 text-gray-600 leading-normal">
              ...
              <a href="mailto:together@charityshopexchange.com" target="_top"><button className="bg-new-navy py-2 sm:py-3 px-12 sm:px-12 text-sm sm:text-lg mt-20 font-base rounded-full text-white  hover:border-none focus:outline-none focus:shadow-outline hover:bg-red-700 ">
          Contact Us
          </button></a>
              </div>
