    ...
    <Layout>
      <div className="flex flex-col sm:flex-none sm:max-w-screen-md mx-auto px-3 sm:px-0 ">
        ...
        <div className="w-4/5 mx-auto text-base sm:text-lg text-gray-700 font-normal mb-8 sm:mb-12 leading-relaxed sm:leading-relax">
          <h2 className="text-xl sm:text-2xl font-semibold font-bold text-left mt-12 mb-4 sm:mb-6 text-red-700 leading-snug">
            1. Terms
          </h2>

          <p className="mb-4">
            By accessing the website at{' '}
            <a href="https://charityshopexchange.com">
              https://charityshopexchange.com
            </a>
          ...
          <ol className="list-alpha list-inside">
            <li className="mb-4">
              ...
              materials (information or software) on Charity Shop
              Exchange&apos;s website for personal, non-commercial transitory
              ...
              <ol className="list-roman m-4 pl-4">
                ...
                <li className="mb-4">
                  ...
                  contained on Charity Shop Exchange&apos;s website;
                </li>
                <li className="mb-4">
            ...
            <li>
              ...
              these restrictions and may be terminated by Charity Shop Exchange
          ...
          <ol className="list-alpha list-inside">
            <li className="mb-4">
              The materials on Charity Shop Exchange&apos;s website are provided
              on an &apos;as is&apos; basis. Charity Shop Exchange makes no
            ...
            <li className="mb-4">
              Further, Charity Shop Exchange does not warrant or make any
          ...
          <p className="mb-4">
            In no event shall Charity Shop Exchange or its suppliers be liable
            ...
            Exchange&apos;s website, even if Charity Shop Exchange or a Charity
            Shop Exchange authorised representative has been notified orally or
          ...
          <p className="mb-4">
            The materials appearing on Charity Shop Exchange&apos;s website
            could include technical, typographical, or photographic errors.
            Charity Shop Exchange does not warrant that any of the materials on
            its website are accurate, complete or current. Charity Shop Exchange
            may make changes to the materials contained on its website at any
            time without notice. However Charity Shop Exchange does not make any
          ...
          <p className="mb-4">
            Charity Shop Exchange has not reviewed all of the sites linked to
            ...
            Charity Shop Exchange of the site. Use of any such linked website is
          ...
          <p className="mb-4">
            Charity Shop Exchange may revise these terms of service for its
          ...
          <p className="mb-4">
            ...
            contact us by email: together@charityshopexchange.com
          </p>
        </div>
      </div>
    </Layout>
