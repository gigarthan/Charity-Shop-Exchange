        ...
        <div className="w-4/5 mx-auto text-base sm:text-lg text-gray-700 font-normal mb-8 sm:mb-12 leading-relaxed sm:leading-relax">
          ...
          <ol className="list-alpha list-inside">
            <li className="mb-4">
              ...
              materials (information or software) on Charity Shop Exchange's
          ...
          <ol className="list-alpha list-inside">
            <li className="mb-4">
              The materials on Charity Shop Exchange's website are provided on
              an 'as is' basis. Charity Shop Exchange makes no warranties,
          ...
          <p className="mb-4">
            ...
            website, even if Charity Shop Exchange or a Charity Shop Exchange
          ...
          <p className="mb-4">
            The materials appearing on Charity Shop Exchange's website could
            include technical, typographical, or photographic errors. Charity
            Shop Exchange does not warrant that any of the materials on its
            website are accurate, complete or current. Charity Shop Exchange may
            make changes to the materials contained on its website at any time
            without notice. However Charity Shop Exchange does not make any
