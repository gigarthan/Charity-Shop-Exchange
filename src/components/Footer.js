  ...
  return (
    <div className="bg-new-navy pt-12 sm:pt-20 pb-8 px-12 sm:px-20">
      ...
      <div className="flex flex-col items-center flex-wrap sm:flex-row sm:items-start max-w-screen-lg justify-between sm:mx-auto">
        <div className="text-gray-300 text-center text-xs w-full lg:w-auto">
          © 2020 Charity Shop Exchange
        </div>
        <div className="flex flex-col sm:flex-row text-xs w-full lg:w-auto flex-wrap justify-center text-center text-gray-200 cursor-pointer mt-4 sm:mt-0">
          <div className="flex flex-col sm:flex-row">
            <Link className="mr-0 sm:mr-4" to="/privacy">
              Privacy
            </Link>
