...
export default function Footer({ isHide }) {
  return (
    <div
      className={`${
        isHide ? 'bg-new-lightgray' : 'bg-new-navy'
      } pt-12 sm:pt-20 pb-8 px-12 sm:px-20`}>
      {isHide ? null : (
        <div>
      ...
      <div className="flex flex-col items-center flex-wrap sm:flex-row sm:items-start max-w-screen-lg justify-between sm:mx-auto">
        ...
        <div className="flex flex-col sm:flex-row text-xs w-full lg:w-auto flex-wrap justify-center text-center mt-4 sm:mt-0">
          <div className="flex flex-col sm:flex-row">
            <Link
              className={`mr-0 sm:mr-4 text-gray-400 ${
                isHide ? 'hover:text-gray-700' : 'hover:text-white'
              } `}
              to="/privacy">
              Privacy
            </Link>
            ...
            <Link
              className={`mr-0 sm:mx-4 text-gray-400 ${
                isHide ? 'hover:text-gray-700' : 'hover:text-white'
              }`}
              to="/terms">
              Terms
          ...
          {/* <div className="block">
            <a
              className="mr-0 sm:mx-4 text-gray-400 hover:text-white"
